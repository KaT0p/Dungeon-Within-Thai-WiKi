...
const sections = [
  ...
  ['A', 'สกิลมอนสเตอร์ Tier 1–5', 'คลังชื่อไทย–อังกฤษของการโจมตี คุณลักษณะติดตัว และชิ้นส่วน พร้อมสถานะข้อมูลที่ยังขาด', '/wiki/monster-skills', '45 ตัว · 160 ชื่อ'],
  ...
  ['✓', 'Roadmap', 'ความคืบหน้าของการวิจัยและหัวข้อที่จะทำต่อ', '/roadmap', '17 หัวข้อเสร็จ'],
];

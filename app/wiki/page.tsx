...
const sections = [
  ...
  ['A', 'สกิลมอนสเตอร์ Tier 1–3', 'คลังชื่อไทย–อังกฤษของการโจมตี คุณลักษณะติดตัว และชิ้นส่วนมอนสเตอร์ช่วงต้นเกม', '/wiki/monster-skills', '26 ตัว · 130 ชื่อ'],
  ...
  ['✓', 'Roadmap', 'ความคืบหน้าของการวิจัยและหัวข้อที่จะทำต่อ', '/roadmap', '16 หัวข้อเสร็จ'],
];
